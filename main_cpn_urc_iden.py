...
if __name__ == '__main__':
    ...
    try:
        ...
        short_memo = ['cpn uniform random crop test with previous test loader base study n=20']
        ...
        for i in range(len(short_memo)):
            ...
            opts.is_resize_test = True
            opts.resize_test = (496, 468)   
            opts.crop_size_test = (512, 448)        
